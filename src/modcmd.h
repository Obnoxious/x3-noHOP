...
#define MODCMD_REQUIRE_ADMINSERV_OPER 0x800000
#define MODCMD_REQUIRE_ADMINSERV_ADMIN 0x1000000
#define MODCMD_REQUIRE_STAFF          (MODCMD_REQUIRE_OPER|MODCMD_REQUIRE_ADMINSERV_ADMIN|MODCMD_REQUIRE_ADMINSERV_OPER|MODCMD_REQUIRE_NETWORK_HELPER|MODCMD_REQUIRE_SUPPORT_HELPER)
